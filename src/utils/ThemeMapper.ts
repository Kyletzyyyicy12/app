...
export const webThemeMapping = {
  ...
  // New 18 theme presets for mobile wheel redesign
  'school-colors': {
    primary: '#8E0B16',
    secondary: '#FFC107',
    background: '#FFFFFF',
...
export function webThemeToMobile(webThemeName: string, isDark: boolean = false): Theme {
...
export function cssVariablesToMobileTheme(cssVars: { [key: string]: string }): Partial<Theme> {
...
export function getThemeFromSessionConfig(themeConfig: any): Theme | null {
